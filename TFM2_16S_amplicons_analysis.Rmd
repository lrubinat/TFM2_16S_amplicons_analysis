...
plot(sort(pielou_evenness_18S_tax_occur_ss16509), pch=19, main="TP 16S Pielou's index", xlab="sample no.", ylab="Pielou's index")
boxplot(pielou_evenness_18S_tax_occur_ss16509,  pch=19, main="TP 16S Pielou's index", xlab="sample no.", ylab="Pielou's index")
```
...
plot(tb16_tax_occur_ss16509_prestonfit, main="TP 16S fit to Preston log-normal model \n(pooled species)")
...
plot(tb16_tax_occur_ss16509_prestonfit, main="TP 18S fit to Preston log-normal model \n(red: pooled; blue: non-pooled)")
...
tb16_ss16509_abundant_sorted_prov<-tb16_ss16509_abundant_sorted_prov[order( tb16_ss16509_abundant_sorted_prov$mean_rabund, tb16_ss16509_abundant_sorted_prov$perc_occur, decreasing = T), c(1,2,3,5,4)]
...
otu_tb16_ss16509_cosmop_sorted_prov<-otu_tb16_ss16509_cosmop_sorted_prov[order(otu_tb16_ss16509_cosmop_sorted_prov$perc_occur, otu_tb16_ss16509_cosmop_sorted_prov$mean_rabund, decreasing = T), c(1,2,3,5,7)]
...
```{r count_samples_per_group_16S.protists, echo=T, warning=FALSE}
occurrence_counts_phototrophs<-data.table()
nrow(tb16_phototrophs)
